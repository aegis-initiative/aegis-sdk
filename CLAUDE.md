...
## Project
AEGIS client SDK — dual-language monorepo providing TypeScript/JavaScript and Python client libraries for the AEGIS Governance Platform.
...
## Current Focus
Initial scaffold complete — TypeScript and Python package structure with stub implementations. Next: implement HTTP client when aegis-platform API is available.
